...
const data = [
  {
    ...
    description: 'Utilizamos o melhor da tecnologia para otimizar seus processos e modelo de negócio.',
  },
  {
    id: 2,
    title: 'Marketing Digital',
    description: 'Desde a estratégia até a alta performance do seu negócio. Branding, copywriting, performance, lançamentos de produtos e tudo que for necessário para seu posicionamento digital.',
  },
  {
    id: 3,
    title: 'Máquina de Crescimento',
    description: 'Uma máquina de alta performance pronta para integrar com sua empresa. Mecânica de geração de Leads, Relacionamento por email, Planejamento de conteúdo, Qualificação de leads, estratégias de SEO e tudo que você precisa para entender a jornada do seu cliente.',
  },
  {
    id: 4,
    title: 'Tecnologia',
    description: 'Utilizamos os melhores recursos tecnológicos para escalar seu negócio.',
  },
  {
    id: 5,
    title: 'Infraestrutura em Nuvem',
    description: 'Migração com segurança e estabilidade para os melhores serviços de nuvem do mercado, utilizamos AWS com profissionais qualificados e certificados para acompanhar todo seu processo.',
  },
  {
    id: 6,
...
const Slider: React.FC = () => {
  ...
  return (
    <S.Wrapper>
      <S.Header>{currentItem.id < 10 ? `0${currentItem.id}` : currentItem.id}<div /></S.Header>
